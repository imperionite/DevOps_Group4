...
This document records the development environment setup status for the BrainBytes project.
...
| Team Member | `docker --version` | `docker compose version` |
|---|---|---|
| Roxane Myles Andrade | _To be filled_ | _To be filled_ |
| Arnel Imperial | _To be filled_ | _To be filled_ |
| Emersson Aporado | _To be filled_ | _To be filled_ |
| Monina Angela Patiño | Docker version 29.4.2, build 055a478 | Docker Compose version v5.1.3 |
